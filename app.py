...
if opcion_pais == "Otro":
    st.session_state.pais_origen = st.text_input("Ingresá el país de origen", value=st.session_state.pais_origen if st.session_state.pais_origen != "China" else "").strip()
else:
...
if submit_clicked:
    ...
    if not st.session_state.form_errors:
        ...
        payload = {
            ...
            "pais_origen": st.session_state.pais_origen,
