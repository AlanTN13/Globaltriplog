...
# -------------------- ESTILOS: Forzar fondo claro + texto #000033 --------------------
st.markdown("""
<style id="force-light">
:root { color-scheme: light !important; }

/* Fondo SIEMPRE claro (blanco) en contenedores principales */
...
/* TODO el texto en #000033 (labels, links, captions, métricas, celdas, etc.) */
...
div[data-testid="stTextArea"] textarea:focus{
  ...
  box-shadow:0 0 0 3px rgba(0,0,51,.2) !important;
}
div[data-testid="stTextInput"] input::placeholder,
div[data-testid="stNumberInput"] input::placeholder,
div[data-testid="stTextArea"] textarea::placeholder{
  color:#000033 !important; opacity:.55 !important;
}
...
div[data-testid="stRadio"] label{
  ...
  padding:8px 12px !important; margin-right:8px !important;
  color:#000033 !important;
...
[data-testid="stDataFrame"]{
  background:#fff !important; border:1.5px solid #dfe7ef !important;
  border-radius:16px !important; box-shadow:0 8px 18px rgba(17,24,39,.07) !important;
  overflow:hidden;
}
...
/* Fallback overlay (cuando no hay st.modal) */
...
.gt-btn{ display:inline-block; text-align:center; text-decoration:none; cursor:pointer; border:1.5px solid #dfe7ef; border-radius:16px; background:#f0f7ff; color:#000033; padding:12px 16px; }
</style>
...
# Acciones por query param (para cerrar/resetear overlay fallback)
qs = _get_qs()
...
with st.form("cot-form", clear_on_submit=False):
    ...
    with mMid:
        # Número como texto (sin “Press Enter to apply”)
